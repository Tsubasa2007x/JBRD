    ...
    <?php if ($sesionActiva): ?>
      ...
      <div class="user-menu">
        ...
        <div class="dropdown hidden" id="userDropdown">
          ...
          <a href="paginas/perfil.php">⚙️ Configuración</a>
  ...
  <div class="hero-content">
    <div class="hero-text">
      <?php if ($sesionActiva): ?>
        ...
        <a href="paginas/lecciones.php" class="btn-primary btn-lg">Continuar aprendiendo</a>
      <?php else: ?>
...
<section class="servicios" id="servicios">
  ...
  <div class="servicios-grid">
    <div class="servicio-card" onclick="window.location.href='paginas/lecciones.php'">
    ...
    <div class="servicio-card" onclick="window.location.href='paginas/simulador.php'">
      <div class="servicio-icon">📈</div>
      <h3>Simulador</h3>
    ...
    <div class="servicio-card" onclick="window.location.href='paginas/misiones.php'">
      <div class="servicio-icon">🎯</div>
      <h3>Misiones</h3>
    ...
    <div class="servicio-card" onclick="window.location.href='paginas/perfil.php'">
      <div class="servicio-icon">🏆</div>
      <h3>Progreso</h3>
...
<section class="aprender" id="aprender">
  ...
  <div class="aprender-cta">
    <a href="paginas/lecciones.php" class="btn-primary btn-lg">Ver todas las lecciones</a>
    <a href="paginas/misiones.php" class="btn-outline btn-lg">Ver misiones activas</a>
  </div>
</section>
<?php endif; ?>
